              ...
              return (
                <div key={topic.id} className="min-w-0 flex-[0_0_85%] pl-4">
                  <div className="relative h-[22rem] w-full">
                    ...
                    <motion.div
                      className={`absolute inset-0 bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg border-2 border-gray-300 p-4 flex flex-col overflow-hidden shadow-inner ${
                    ...
                    {/* Door - Modified for mobile carousel */}
                    <motion.div
                      ...
                      transition={{
                        ...
                        ease: isOpen
                          ? [0.25, 0.46, 0.45, 0.94]
                          : [0.4, 0.0, 0.2, 1], // Different easing for close
                      }}
                      onClick={!isOpen ? () => toggleCard(topic.id) : undefined}
                    >
                      {/* Door Panel */}
                      <motion.div
                        className="absolute flex h-full w-full flex-col justify-between overflow-hidden rounded-lg border-2 bg-white p-4 shadow-lg"
                        style={{
